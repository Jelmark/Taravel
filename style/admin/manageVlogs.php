...
<table class="table ">
  <div class="header">
  <font class="head-title">Reviews</font>
</div>
  <thead class="thead-dark">
    <tr>
      <th scope="col">UserId</th>
      <th scope="col">Username</th>
      <th scope="col">Vlogs Description</th>
      <th scope="col">Vlogs Files</th>
  ...
  <tbody>
    <tr>
     ...
     <button type="button" class="btn-update">
        <span class="glyphicon glyphicon-ok" aria-hidden="true tooltiptext">Approved
        </span>
     </button>

    <button class="btn-delete glyphicon glyphicon-remove">
